    ...
    public void LoadLib(ReadOnlyTargetRules Target)
    {
        ...
        else if (Target.Platform == UnrealTargetPlatform.IOS)
        {
            ...
            {/* The xml file specifies additional lines for Info.plist
              * The xml file is located on the path: "Plugins\SolanaMobileUE5\Source\SolanaMobileUE5\SolanaMobileUE5_UPL_iOS.xml"
              */}
            
            AdditionalPropertiesForReceipt.Add("IOSPlugin", Path.Combine(ModuleDirectory, "SolanaMobileUE5_UPL_iOS.xml"));
             ...
             * 
             * For example on the path: "Plugins\SolanaMobileUE5\Source\SolanaMobileUE5\ThirdParty\IOS\frameworks"
             ...
             * 
             * Along the path is a test image: "Plugins\SolanaMobileUE5\Source\SolanaMobileUE5\ThirdParty\IOS\bundle\IosDrawable.bundle"
